  ...
  'utilities' => {
    ...
    'newGame' => sub {
      ...
      if(!&{$utility{'Monopoly_existsGame'}}($_[0],$_[1],2)) {
        ...
        @{$game{board}} = @{$lk{tmp}{plugin}{'Monopoly'}{themes}[$game{theme}]{board}};
        ...
        if($lk{data}{plugin}{'Monopoly'}{games}{$_[0]}{$_[1]}{state} =~ /^player_land$/) {
          if(&{$utility{'Monopoly_isTurn'}}($_[0],$_[1],$_[2])) {
            ...
            if($lk{data}{plugin}{'Monopoly'}{games}{$_[0]}{$_[1]}{players}{$_[2]}{money} >= $tile{price}){
              ...
              &{$utility{'Fancify_say'}}($handle,$_[1],"Bought ".(&{$utility{'Monopoly_getTile'}}($_[0],$_[1],$lk{data}{plugin}{'Monopoly'}{games}{$_[0]}{$_[1]}{players}{$_[2]}{position})));
            }
            else {
